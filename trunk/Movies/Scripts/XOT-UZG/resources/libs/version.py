...
if __name__ == "__main__":   
    ...
    version1 = Version(major=2, minor=1, revision=2, build=1)
    #version1 = Version(version="2.1.2.01")
    version2 = Version(version="2.1.3.1")
    print "%s <  %s = %s" % (version1, version2, version1 < version2)
    print "%s <= %s = %s" % (version1, version2, version1 <= version2)
    print "%s == %s = %s" % (version1, version2, version1 == version2)
    print "%s >= %s = %s" % (version1, version2, version1 >= version2)
    print "%s >  %s = %s" % (version1, version2, version1 > version2)
    print "\n%s != %s = %s" % (version1, version2, version1 != version2)
    print "%s EqualRevisions %s = %s" % (version1, version2, version1.EqualRevisions(version2))
