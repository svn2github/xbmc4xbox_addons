...
class BrightCoveHelper:
    ...
    def __init__(self, logger, playerKey, contentId, url, seed, experienceId=0, amfVersion=3):
    ...
    def GetDescription(self):
        ...
        if description:
            ...
            return encodinghelper.EncodingHelper.UnicodeEncode(self.data['longDescription'])        
        return ""
    ...
    def GetStreamInfo(self):
        ...
        for stream in streamData:
            ...
            # The result is Unicode, so we should encode it.
            strm = encodinghelper.EncodingHelper.UnicodeEncode(stream['defaultURL'])
