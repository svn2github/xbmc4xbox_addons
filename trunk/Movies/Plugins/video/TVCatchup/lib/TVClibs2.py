  ...
  if (jamie == "true"):
   if OoO000 [ II11iiii1Ii ] == "enabled" :
    ...
    if iI111iI == "true" :
     ...
     str_list.append(iiIiIIi [ OooO0 ] [ 11 : 16 ])
     str_list.append(" - To: ")
     str_list.append(ooOoo0O [ OooO0 ] [ 11 : 16 ])
     ...
     str_list4 = []
     str_list4.append("Now Showing: ")
     str_list4.append(iiiI11 [ II11iiii1Ii ])
     str_list4.append(". Up Next: ")
     str_list4.append(iiiI11n [ II11iiii1Ii ])
     str_list4.append(".")
     OO0o ( "".join(str_list), "".join(str_list2) , 3 , "".join(str_list3) , ooOoo0Opd [ II11iiii1Ii ] , ooOoo0Opg [ II11iiii1Ii ] , ooOoo0Opdes [ II11iiii1Ii ] , "".join(str_list4) , len ( iiiIi )  )
     OooO0 = OooO0 + 1
    else :
     str_list = []
     str_list.append(str ( II11iiii1Ii + 1 ))
   ...
   OooO0 = OooO0 + 1
 ii [ 5 ] . endOfDirectory ( 0, cacheToDisc=False )
...
def OO0o ( name , url , mode , iconimage , duration , genre , description , realname , total ) :
 ...
 if (iI111iI<>"true"):
  ...
  OooOooooOOoo0 . setInfo ( type = "Video" , infoLabels = { "Title" : realname,'genre': genre ,'duration': str(duration) } )
 oo0O0oOOO00oO = ii [ 5 ] . addDirectoryItem ( handle = 0 , url = Ii , listitem = OooOooooOOoo0 , isFolder = False , totalItems = total )
