'''
Image merge.
Code taken from the web and adapted by Anarchintosh

USAGE:
import img_merge
img_merge.make(filename,filepath,image_path_list)
...
def make(filename,filepath,image_path_list):
    format = 'RGBA'
    #size of the image we are packing into
    size = 512,512

    #get a list of image files
    names = image_path_list
    ...
    return os.path.join(filepath,filename+'.jpg')
