...
def showVideo(urlV, vidN):
	...
	swfUrl = "http://www.superrtlnow.de/includes/vodplayer.swf"
	pageUrl = "http://www.superrtlnow.de/p"

	fullData=videoUrl+' swfVfy=1 playpath='+playpath+' app=superrtlnow/_definst_ pageUrl='+pageUrl+'/ tcUrl='+videoUrl+' swfUrl='+swfUrl 
	print fullData
	print "------------"
