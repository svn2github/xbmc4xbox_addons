...
def showVideo(urlV, vidN):
	...
	swfUrl = "http://www.voxnow.de/includes/vodplayer.swf"
	pageUrl = "http://www.voxnow.de/p"

	fullData=videoUrl+' swfVfy=1 playpath='+playpath+' app=voxnow/_definst_ pageUrl='+pageUrl+'/ tcUrl='+videoUrl+' swfUrl='+swfUrl 
	print fullData
	print "------------"
