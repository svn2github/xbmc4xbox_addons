...
urlHost = "http://www.rtlnitronow.de"
...
def showVideo(urlV, vidN):
	...
	swfUrl = "http://www.rtlnitronow.de/includes/vodplayer.swf"
	pageUrl = "http://www.rtlnitronow.de/p"
	

	fullData=videoUrl+' swfVfy=1 playpath='+playpath+' app=rtlnitronow/_definst_ pageUrl='+pageUrl+'/ tcUrl='+videoUrl+' swfUrl='+swfUrl 
	print fullData
	print "------------"
